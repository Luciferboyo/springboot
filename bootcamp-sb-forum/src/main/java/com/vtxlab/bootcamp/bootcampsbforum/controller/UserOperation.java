...
public interface UserOperation {
  ...
  @ResponseStatus(value = HttpStatus.OK)
  ApiResponse<List<com.vtxlab.bootcamp.bootcampsbforum.entity.UserEntity>> getUsersByLatGtrThan(
      @PathVariable(value = "lat") String latitude);

  @GetMapping(value = "/users/email/{email}/phone/{phone}")
  @ResponseStatus(value = HttpStatus.OK)
  ApiResponse<List<com.vtxlab.bootcamp.bootcampsbforum.entity.UserEntity>> getUsersByEmailAndPhone(
      @PathVariable String email, @PathVariable String phone);

  
  @PutMapping
  ApiResponse update(Long id,String mail);
}